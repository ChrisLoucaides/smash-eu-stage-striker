...
export const LEGAL_STAGES: Stage[] = [
  {
    id: 'battlefield',
    name: 'Battlefield',
    imageUrl: getAssetPath('battlefield.webp'),
    isLegal: true,
  },
  {
    id: 'final-destination',
    name: 'Final Destination',
    imageUrl: getAssetPath('final-destination.webp'),
    isLegal: true,
  },
  {
    id: 'small-battlefield',
    name: 'Small Battlefield',
    imageUrl: getAssetPath('small-battlefield.webp'),
    isLegal: true,
  },
  {
    id: 'pokemon-stadium-2',
    name: 'Pokémon Stadium 2',
    imageUrl: getAssetPath('pokemon-stadium-2.webp'),
    isLegal: true,
  },
  {
    id: 'smashville',
    name: 'Smashville',
    imageUrl: getAssetPath('smashville.webp'),
    isLegal: true,
  },
  {
    id: 'town-and-city',
    name: 'Town and City',
    imageUrl: getAssetPath('town-and-city.webp'),
    isLegal: true,
  },
  {
    id: 'kalos-pokemon-league',
    name: 'Kalos Pokémon League',
    imageUrl: getAssetPath('kalos-pokemon-league.webp'),
    isLegal: true,
  },
  {
    id: 'hollow-bastion',
    name: 'Hollow Bastion',
    imageUrl: getAssetPath('hollow-bastion.webp'),
    isLegal: true,
  },
  {
    id: 'yoshis-story',
    name: 'Yoshi\'s Story',
    imageUrl: getAssetPath('yoshis-story.webp'),
    isLegal: true,
  },
];
